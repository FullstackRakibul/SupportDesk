...
import siteLogo from '../assets/hameem.png'
function Login() {
  return (
    <>
      <div class="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
        <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md ">
            <div className="flex justify-center items-center py-3">
                <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHKmNXWEylQUBR8R4xlepBvW8vkdRsTy82tit8SZE&s' />
            </div>
          <div class="bg-white shadow-md w-full rounded-lg divide-y divide-gray-200">
            <div class="px-5 py-7">
              ...
              <button
                type="button"
                class="transition duration-200 bg-primary hover:bg-secondary focus:bg-blue-700 focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block"
              >
